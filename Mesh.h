...
class CMirrorBoxMesh : public CMeshTexturedIlluminated
{
protected:
	int							m_nWidth;
	int							m_nLength;
...
public:
	CMirrorBoxMesh(ID3D11Device *pd3dDevice, float fWidth = 20.0f, float fHeight = 20.0f, float fDepth = 20.0f, float fScale = 5.0f);
	virtual ~CMirrorBoxMesh();
};
