...
void CScene::BuildObjects(ID3D11Device *pd3dDevice)
{
	...
	CWaterBoxShader *pWaterBoxShader = new CWaterBoxShader();
	pWaterBoxShader->CreateShader(pd3dDevice);
	pWaterBoxShader->BuildObjects(pd3dDevice, GetTerrain());
	m_ppShaders[5] = pWaterBoxShader;

	CMirrorShader *pMirrorShader = new CMirrorShader();
	pMirrorShader->CreateShader(pd3dDevice);
	pMirrorShader->BuildObjects(pd3dDevice, GetTerrain());
