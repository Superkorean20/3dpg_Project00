...
class CTranslatedTexturedIlluminatedShader : public CTexturedIlluminatedShader
{
public:
	CTranslatedTexturedIlluminatedShader();
	virtual ~CTranslatedTexturedIlluminatedShader();
...
class CWaterBoxShader : public CTranslatedTexturedIlluminatedShader
{
public:
	CWaterBoxShader();
